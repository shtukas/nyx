...
class Ninja
    ...
    def self.getCatalystObjects()
        ...
        metric = 0.2 + 0.4*Math.exp(-FIFOQueue::size(CATALYST_COMMON_XCACHE_REPOSITORY, "timestamps-5bd4-431b-9eef-24ca1d005a3c").to_f/16) + Saturn::traceToMetricShift("deb58288-31e9-4d20-848d-8ac33d3701ee")
        [
            {
                "uuid" => "96287511",
                "metric" => metric,
