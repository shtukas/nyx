...
class AgentStream
    ...
    def self.generalFlockUpgrade()
        ...
        return if !KeyValueStore::getOrNull(CATALYST_COMMON_PATH_TO_KV_REPOSITORY, "b6b96f14-3cb5-4182-8f1e-925d83d01e89:#{CommonsUtils::currentDay()}").nil?
        ...
        KeyValueStore::set(CATALYST_COMMON_PATH_TO_KV_REPOSITORY, "b6b96f14-3cb5-4182-8f1e-925d83d01e89:#{CommonsUtils::currentDay()}", "done")
    end
