...
class Waves
    ...
    # Waves::items()
    def self.items()
        Librarian20LocalObjectsStore::getObjectsByMikuType("Wave")
    end

    # Waves::itemsForUniverse(universe)
    def self.itemsForUniverse(universe)
        Librarian20LocalObjectsStore::getObjectsByMikuTypeAndUniverse("Wave", universe)
    end
    ...
    def self.issueNewWaveInteractivelyOrNull()
        ...
        Librarian20LocalObjectsStore::commit(wave)
        wave
    end
    ...
    def self.access(item)
        ...
        loop {
            ...
            if operation == "landing" then
                ...
                if Librarian20LocalObjectsStore::getObjectByUUIDOrNull(item["uuid"]).nil? then
                    break
                end
            end
