...
class Topping
    ...
    def self.getText(universe)
        ...
        filepath = "/Users/pascal/Galaxy/DataBank/Didact/Catalyst/Multiverse/tops/#{universe}.txt"
    ...
    def self.putTextToDataBank(text, universe)
        ...
        filepath = "/Users/pascal/Galaxy/DataBank/Didact/Catalyst/top-text-versions/#{Time.new.strftime("%Y")}/#{Time.new.strftime("%Y-%m")}/#{unixtime}-#{universe}.txt"
