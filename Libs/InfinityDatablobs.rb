...
class InfinityDatablobs_DriveWithLocalXCache

    # InfinityDatablobs_DriveWithLocalXCache::commitToDatablobsInfinityBufferOut(blob)
...
class InfinityElizabeth_DriveWithLocalXCache
