...
Usage:
    ...
    puts "select / expose / start / done (<n>) | no work today | wave / calendar item / quark / todo / work item / project | anniversaries | calendar | waves | agents | numbers on/off".yellow
