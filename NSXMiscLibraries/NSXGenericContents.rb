...
class NSXGenericContents
    ...
    # NSXGenericContents::filenameToFilepath(filename)
    ...
    def self.issueItemEmail(email)
        ...
        emailFilepath = NSXGenericContents::filenameToFilepath(emailFilename)
    ...
    def self.makeItemEmailSideEffectEmailToDisk(rawemail)
        ...
        filepath = NSXGenericContents::filenameToFilepath(filename)
    ...
    def self.sendItemToDisk(item)
        filepath = NSXGenericContents::filenameToFilepath(item["filename"])
    ...
    def self.filenameToCatalystObjectAnnounce(genericContentFilename)
        filepath = NSXGenericContents::filenameToFilepath(genericContentFilename)
