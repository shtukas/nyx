...
class NSXGenericContents
    ...
    def self.newItemFilepathForFilename(filename)
        ...
        frg2 = filename[0,6]
        frg3 = filename[0,8]
        folder1 = "#{CATALYST_COMMON_DATABANK_CATALYST_INSTANCE_FOLDERPATH}/Generic-Contents/#{frg1}/#{frg2}/#{frg3}"
    ...
    def self.filenameToFilepathResolutionOrNullUseTheForce(filename)
        Find.find("#{CATALYST_COMMON_DATABANK_CATALYST_INSTANCE_FOLDERPATH}/Generic-Contents") do |path|
