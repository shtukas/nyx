...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentAnniversaries::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentBackupsMonitor::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentDailyGuardianWork::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentDailyTimeCommitments::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentDesktopLucilleFile::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentStreams::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentVideosStreamConsumptionMonitor::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentWave::getCommands() },
...
NSXBob::registerAgent(
    {
        ...
        "agent-commands" => lambda { NSXAgentDesktopFilesMonitor::getCommands() },
