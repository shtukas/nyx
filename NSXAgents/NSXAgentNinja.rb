...
class NSXAgentNinja
    ...
    def self.impactMetricCoefficient()
        impacts = NSXAgentNinja::getImpactsFromDisk().reject{|impact| (Time.new.to_i - impact) > 86400 }
